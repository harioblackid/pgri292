...
<head>
    <script src="dist/bootstrap5/color-modes.js"></script>
    ...
    <link href="dist/bootstrap5/bootstrap.min.css" rel="stylesheet">
...
<body class="d-flex align-items-center py-4 bg-body-tertiary">
    ...
    <main class="form-signin w-100 m-auto">
        <form id="formlogin" action="ceklogin.php">
            <img class="mb-4" src="<?php echo $setting['logo']; ?>" alt="" width="72" height="72">
            ...
            <p class="mt-5 mb-3 text-body-secondary">&copy; <?php echo $setting['sekolah']; ?> 2020–<?php echo date('Y'); ?></p>
        </form>
    </main>
    <script src="dist/bootstrap5/bootstrap.bundle.min.js"></script> 
