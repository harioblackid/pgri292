                ...
                <div class="box-body">
                    ...
                    <ul class="list-group">
                        <li class="list-group-item"><img src="../dist/img/support.png" width="45" alt="">
                            <a href="https://www.youtube.com/watch?v=yi9pnCjYIdo" target="_blank" class="btn btn-success">
                                <i class="fas fa-globe    "></i> Website
                            </a></li>
                        <li class="list-group-item"><img src="../dist/img/support.png" width="45" alt="">
                            <a href="https://www.youtube.com/watch?v=yi9pnCjYIdo" target="_blank" class="btn btn-primary">
                                <i class="fab fa-telegram-plane"></i> Telegram
                            </a></li>
                        <li class="list-group-item"><img src="../dist/img/support.png" width="45" alt="">
                            <a href="https://www.youtube.com/watch?v=yi9pnCjYIdo" target="_blank" class="btn btn-danger">
