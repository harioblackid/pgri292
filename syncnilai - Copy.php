...
if ($cektoken <> 0) {
    ...
    foreach ($decoded as $nilai) {
        ...
        if ($cek == 0) {
            mysqli_query($koneksi, "REPLACE INTO nilai (id_ujian,id_mapel,id_siswa,kode_ujian,ujian_mulai,ujian_berlangsung,ujian_selesai,jml_benar,jml_salah,skor,total,ipaddress,hasil,jawaban,jawaban_esai)
